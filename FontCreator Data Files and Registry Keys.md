...
* Tags from **tags.txt** and **Tagged** folder from `TFONTOVERVIEWFORM` – The menu items do nothing when clicked; use the same menu items from the glyph overview context menu by right clicking any glyph.
