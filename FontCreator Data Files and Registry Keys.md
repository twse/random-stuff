...
>>>>>>> d8ef4a0 (Updated FontCreator application data)
...
* **TEXPORTSETTINGSFORM** and **TEXPORTSETTINGSFRAME** – Configure font export settings such as changing the outline format (TrueType or CFF/PostScript) and the output folder.
