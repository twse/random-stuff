...
* **glyphnames.dat** (version 7.0 until 11.5) and **glyphnamesnew.dat** (version 12.0 & above) – “Contains overrides of the default friendly glyph names, as used when opening existing fonts (and fonts without PostScript names) and when you generate glyph names on the Glyph Properties dialog”.
...
* **OpenFriendlyGlyphNames** (version 12.0.0.2521 & above) – Used with **Open Font: Generate friendly glyph names (recommended)**. Default is on.
