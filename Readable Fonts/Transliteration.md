...
avesta.orgtranscription (2010), a font in OpenType PostScript format, is based on Mithra (2000) and designed for use with Avestan and Pahlavi. The font was created using FontCreator 6.2 (2010). Many numbers and punctuation marks are shown in Garava. Download this font from [here](http://www.avesta.org/fonts/index.html).
...
| C caron             | No key assigned | Alt-134         |
...
| O circumflex        | No key assigned | Alt-163         |
...
| a dot above         | No key assigned | Alt-131         |
| a dot below         | Alt-196         | No key assigned |
...
| right half ring    | Alt-0245        | Alt-n then Shift-n     |
