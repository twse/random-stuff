...
* **Cyrano Text**: TrueType Unicode font based on Cyrano Nouveau (2009) from Tim "MrMoto" Mott (Typophile) with some glyphs modified.
* **FontCreator Data Files and Registry Keys.md**: Information about data files and registry keys used by FontCreator.
