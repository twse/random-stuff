...
* **Cyrano Text**: TrueType Unicode font based on Cyrano Nouveau (2009) from the Typophile forums by MrMoto with revised glyphs and support for more glyphs. Created using FontCreator 5.6. Can't create a link to the original topic at Typophile since the site produces uncaught exceptions when searching. Both fonts are named after the 1998 movie Cyrano de Bergerac.
