...
* **EasyPaint** by Nikita Grishko et al. to German, Korean, Polish, Portuguese (Brazil), Spanish and Swedish (UTF-8). In the distribution only Chinese (Simplified), Czech, French and Russian translations are spread.
