...
* **This page can't be displayed** (Internet Explorer 11) – In this page is a button labeled **Fix connection problems** (pressing in the browser itself when the original page is accessed as `res://ieframe.dll/dnserror.htm` opens the network diagnostic tool and makes the menu item not dimmed – it's also in the **Tools** menu). The page title changes to **You're not connected to the internet** for computers not connected to the internet.
