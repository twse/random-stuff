...
* **Cyrano Text**: TrueType Unicode font based on Cyrano Nouveau (2009) by Tim "MrMoto" Mott (Typophile) with some glyphs modified. Created using FontCreator 5.6 (2007). **Moderator's note:** Both fonts are named after Cyrano de Bergerac.
