...
Python Software Foundation has a contributor license agreement that you must sign to review or merge pull requests when contributing to Python (e.g. when updating the documentation).
...
Make sure your Python bug tracker account is linked to your GitHub account (you can do this by logging in to your account and going to the account settings page to set your username; only the Python bug tracker usernames are included).
